...
-- book
-- -----------------------------------------------------
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (1,'Р‘РѕР¶РµСЃС‚РІРµРЅРЅР°СЏ РєРѕРјРµРґРёСЏ','ISBN-01234-0123',125,3,1,'NULL','');
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (2,'РЎРєР°Р·РєРё','ISBN-01234-0124',300,5,2,'NULL','NULL');
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (3,'Р� РїСЂРёС€Р»Рѕ СЂР°Р·СЂСѓС€РµРЅРёРµ','ISBN-01234-0125',245.5,1,2,'NULL','NULL');
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (4,'РћС‚РµС† Р“РѕСЂРёРѕ','ISBN-01234-0126',46,3,2,'','');
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (5,'Р’С‹РјС‹СЃР»С‹','ISBN-01234-0127',118.3,4,2,'NULL','');
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (6,'Р”РµРєР°РјРµСЂРѕРЅ','ISBN-01234-0128',148.7,2,3,'NULL','NULL');
INSERT INTO `book` (`id`,`title`,`isbn`,`price`,`count`,`category_id`,`cover`,`description`) VALUES (7,'Р’РѕРїСЂРѕСЃ Рѕ РІРѕРґРµ Рё Р·РµРјР»Рµ','ISBN-01234-0133',125,4,4,'NULL','');

-- -----------------------------------------------------
-- author
-- -----------------------------------------------------
INSERT INTO `author` (`id`,`title`) VALUES (1,'Р”Р°РЅС‚Рµ РђР»РёРіСЊРµСЂРё');
INSERT INTO `author` (`id`,`title`) VALUES (2,'РҐР°РЅСЃ РљСЂРёСЃС‚РёР°РЅ РђРЅРґРµСЂСЃРµРЅ');
INSERT INTO `author` (`id`,`title`) VALUES (3,'Р§РёРЅСѓР° РђС‡РµР±Рµ');
INSERT INTO `author` (`id`,`title`) VALUES (4,'РћРЅРѕСЂРµ РґРµ Р‘Р°Р»СЊР·Р°Рє');
INSERT INTO `author` (`id`,`title`) VALUES (5,'РҐРѕСЂС…Рµ Р›СѓРёСЃ Р‘РѕСЂС…РµСЃ');
INSERT INTO `author` (`id`,`title`) VALUES (6,'Р”Р¶РѕРІР°РЅРЅРё Р‘РѕРєРєР°С‡С‡Рѕ');
